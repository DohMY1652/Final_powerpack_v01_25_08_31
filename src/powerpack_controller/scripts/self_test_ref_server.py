...
ref_values = [
    11632,   11632,  11132,  11132,  # 채널 0, 1, 2, 3
    13132,  11132,  8632,  8632,  # 채널 4, 5, 6, 7
    9132,  9132,  10132,  10132   # 채널 8, 9, 10, 11
]
# ref_values = [
#     9832,   9832,  9832,  9832,  # 채널 0, 1, 2, 3
#     9832,  9832,  10332,  10332,  # 채널 4, 5, 6, 7
#     10332,  10332,  10332,  10332   # 채널 8, 9, 10, 11
# ]
# ref_values = [
#     13000,   13000,  13000,  13000,  # 채널 0, 1, 2, 3
#     13000,  13000,  7000,  7000,  # 채널 4, 5, 6, 7
#     7000,  7000,  7000,  7000   # 채널 8, 9, 10, 11
# ]
# --- ---
